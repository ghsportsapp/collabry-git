  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        short_name: "Collabry",
        description:
          "Collabry — India's marketplace for brands and creators to collaborate.",
        theme_color: "#0A0A0F",
      ...
      workbox: {
        ...
        // Don't precache the FCM SW (kept as a static file in /public);
        // it ships unmodified so the Firebase scripts can load it via importScripts.
