...
export default function ForgotPasswordCreator() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const res = await fetch(`${BASE_URL}/api/auth/creator/forgot-password`, {
        method: "POST",
          ...
          {sent ? (
            ...
            <>
              ...
              <div className="flex items-center justify-center gap-1.5 mt-6">
                ...
                <Link href="/login-creator" className="text-white/70 text-xs hover:text-white transition-colors">
                  Back to Login
                </Link>
              </div>
            </>
