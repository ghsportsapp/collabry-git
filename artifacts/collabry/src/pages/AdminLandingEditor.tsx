...
const DEFAULT_CONTENT: Record<string, ContentItem> = {
  ...
  "hero.heading_line1": { key: "hero.heading_line1", value: "Collaborate", type: "text", section: "hero" },
  "hero.heading_highlight1": { key: "hero.heading_highlight1", value: "Smarter.", type: "text", section: "hero" },
  "hero.heading_line2": { key: "hero.heading_line2", value: "Grow", type: "text", section: "hero" },
